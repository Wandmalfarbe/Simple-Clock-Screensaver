...
class SeikoStandardKX308K: ClockSkin {
    ...
    class Color: NSObject, ClockSkinColor {
        ...
        let clockBackground = NSColor(red: 1, green: 1, blue: 1, alpha: 0).cgColor

        let border = NSColor(srgbRed: 0.0628, green: 0.1178, blue: 0.1187, alpha: 1.0).cgColor
        let majorTick = NSColor(srgbRed: 0.0628, green: 0.1178, blue: 0.1187, alpha: 1.0).cgColor
        let minorTick = NSColor(srgbRed: 0.0628, green: 0.1178, blue: 0.1187, alpha: 1.0).cgColor

        let secondHand = NSColor(srgbRed: 0.0628, green: 0.1178, blue: 0.1187, alpha: 1.0).cgColor
        let minuteHand = NSColor(srgbRed: 0.0628, green: 0.1178, blue: 0.1187, alpha: 1.0).cgColor
        let hourHand = NSColor(srgbRed: 0.0628, green: 0.1178, blue: 0.1187, alpha: 1.0).cgColor
