...
class SwissRailwayClockDark: ClockSkin {
    ...
    class Color: NSObject, ClockSkinColor {
        let screenBackground = NSColor(red: 0.1486, green: 0.1486, blue: 0.1486, alpha: 1.0).cgColor
        ...
        let minorTick = NSColor(red: 1, green: 1, blue: 1, alpha: 1).cgColor
        
        let secondHand = NSColor(red: 0.7322, green: 0.0957, blue: 0.0, alpha: 1.0).cgColor
        let minuteHand = NSColor(red: 1, green: 1, blue: 1, alpha: 1).cgColor
        let hourHand = NSColor(red: 1, green: 1, blue: 1, alpha: 1).cgColor
