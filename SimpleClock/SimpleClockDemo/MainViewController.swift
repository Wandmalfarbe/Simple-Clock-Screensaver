...
class MainViewController: NSViewController {
    ...
    override func viewDidLoad() {
		...
		let timer = Timer.scheduledTimer(timeInterval: clockView.animationTimeInterval, target: clockView, selector: #selector(SimpleClock.animateOneFrame), userInfo: nil, repeats: true)
		...
		clockSizeSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "clockFaceHeight", options: nil)
		borderSizeSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "borderWidth", options: nil)

		majorTickWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "majorTickWidth", options: nil)
		majorTickHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "majorTickHeight", options: nil)
		majorTickRadiusSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "majorTickRadius", options: nil)

		minorTickWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "minorTickWidth", options: nil)
		minorTickHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "minorTickHeight", options: nil)
		minorTickRadiusSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "minorTickRadius", options: nil)

		secondHandWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "secondHandWidth", options: nil)
		secondHandHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "secondHandHeight", options: nil)
		secondHandOverhangWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "secondHandOverhangWidth", options: nil)
		secondHandOverhangHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "secondHandOverhangHeight", options: nil)

		minuteHandWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "minuteHandWidth", options: nil)
		minuteHandHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "minuteHandHeight", options: nil)
		minuteHandOverhangWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "minuteHandOverhangWidth", options: nil)
		minuteHandOverhangHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "minuteHandOverhangHeight", options: nil)

		hourHandWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "hourHandWidth", options: nil)
		hourHandHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "hourHandHeight", options: nil)
		hourHandOverhangWidthSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "hourHandOverhangWidth", options: nil)
		hourHandOverhangHeightSlider.bind("value", to: liveSkin.scaling as AnyObject, withKeyPath: "hourHandOverhangHeight", options: nil)

		lineCapButton.bind("selectedIndex", to: liveSkin.lineCap as AnyObject, withKeyPath: "minorTick", options: nil)
